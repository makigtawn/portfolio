...
//       initial="hidden"
//       animate="visible"
//       className="p-6 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
...
//           I build clean, thoughtful interfaces with a focus on detail, strict
//           type structural restraint, and minimal footprint.
//         </motion.p>
...
//       {/* Right Column: Code Window Graphic Block */}
...
//             </p>
//             <p className="text-brand-mutedLight dark:text-brand-mutedDark overflow-hidden whitespace-nowrap">
//               <motion.span
//                 initial={{ width: 0 }}
//                 animate={{ width: "100%" }}
